...
console.log(total); /**phương thức sẽ xử lý từng bước một theo cấu trúc  x1 + x2 = y1, sau đó mới tính tiếp y1 + x3 = y2 và cuối cùng là y2 + x4 = y3 = 10 là kết quả cuối cùng  */
...
var minCourses = courses.sort(function(a, b) { /**sắp xếp theo thứ tự từ miễn phí đến đắt phí nhất */
...
var maxCourses = courses.sort(function(a, b) { /**sắp xếp theo thứ tự từ đắt phí nhất đến miễn phí */
